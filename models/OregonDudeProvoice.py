...
# raw_user_input = input("Hey man what's happening?") #don't need for real model
# user_input = raw_user_input.lower().translate(str.maketrans('','', string.punctuation))

def get_oregon_response(self, input):
